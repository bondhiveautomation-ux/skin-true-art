...
const WELCOME_SHOWN_KEY = "creators_studio_welcome_shown";
      ...
      <DialogContent className="sm:max-w-md border-purple-500/30 bg-gradient-to-b from-background to-purple-500/5">
        <DialogHeader className="text-center pb-2">
          ...
          <DialogTitle className="font-serif text-2xl text-center">
            Welcome to <span className="bg-gradient-to-r from-primary to-rose-gold bg-clip-text text-transparent">Creators Studio!</span>
          </DialogTitle>
