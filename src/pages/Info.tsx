...
const Info = () => {
  ...
  const whatsappMessage = encodeURIComponent(infoContent.whatsapp_message || "Hi, I'd like to request access to BondHive Studio.");
  
  // Info page content
  const pageBadge = infoContent.page_badge || "Knowledge Hub";
  const pageTitle1 = infoContent.page_title_1 || "BondHive Studio";
  ...
  const footerCopyright = (infoContent.footer_copyright || "© {year} BondHive Studio. All rights reserved.")
