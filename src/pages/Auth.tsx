    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description: "Click the link in your email to complete signup and get 50 free gems!",
        });
      }
    } catch (error) {
      toast({
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-20 relative z-10">
        <div className="max-w-lg">
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="font-serif text-2xl font-semibold text-cream">BH Studio</span>
          </div>
          ...
          <p className="text-lg text-cream/60 leading-relaxed mb-10">
            Create, enhance, and brand your content with BH Studio — built for makeup artists, fashion creators, and modern brands.
          </p>
          ...
          <div className="lg:hidden mb-6">
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                ...
                <span className="font-serif text-lg font-semibold text-cream">BH Studio</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-green-500/20 border border-green-500/30">
                <Gift className="w-3.5 h-3.5 text-green-400" />
                <span className="text-xs font-semibold text-green-400">50 Free Gems</span>
              </div>
            </div>
          ...
          <div className="glass-card p-5 sm:p-8 border border-gold/15 rounded-2xl sm:rounded-3xl backdrop-blur-md mt-4 lg:mt-0">
            {showEmailSent ? (
              ...
              <div className="space-y-6 text-center">
                ...
                <div>
                  <h2 className="font-serif text-2xl font-semibold text-cream mb-2">Check Your Email!</h2>
                  <p className="text-sm text-cream/60">
                    We've sent a confirmation link to <span className="text-gold">{pendingEmail}</span>
                  </p>
                  <p className="text-xs text-cream/40 mt-2">
                    Click the link to verify your email and get 50 free gems!
                  </p>
                </div>
                <Button 
                ...
                <button 
                  onClick={() => { setShowEmailSent(false); setActiveTab("login"); }}
              ...
              <div className="space-y-6">
                <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "login" | "signup")} className="w-full">
                  <TabsList className="grid w-full grid-cols-2 bg-charcoal/50 mb-6">
                    <TabsTrigger value="login" className="data-[state=active]:bg-gold data-[state=active]:text-charcoal-deep">
                      Log In
                    </TabsTrigger>
                    <TabsTrigger value="signup" className="data-[state=active]:bg-gold data-[state=active]:text-charcoal-deep">
                      Sign Up
                    </TabsTrigger>
                  </TabsList>
                  ...
                  <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-card px-2 text-cream/40">or</span>
                    </div>
                  </div>
                  ...
                  <TabsContent value="signup" className="space-y-4 mt-0">
                    <form onSubmit={handleSignup} className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="signup-name" className="text-sm text-cream/70">Full Name (optional)</Label>
                        <Input
                          id="signup-name"
                          type="text"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="signup-email" className="text-sm text-cream/70">Email</Label>
                        <Input
                          id="signup-email"
                          type="email"
                        ...
                        />
                        {errors.email && <p className="text-red-400 text-xs">{errors.email}</p>}
                        <p className="text-xs text-cream/40">Only Gmail, Yahoo, and Outlook emails allowed</p>
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="signup-password" className="text-sm text-cream/70">Password</Label>
                        <div className="relative">
                          <Input
                            id="signup-password"
                            type={showPassword ? "text" : "password"}
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="signup-confirm-password" className="text-sm text-cream/70">Confirm Password</Label>
                        <div className="relative">
                          <Input
