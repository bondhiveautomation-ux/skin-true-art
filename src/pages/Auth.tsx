      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-20 relative z-10">
        <div className="max-w-lg">
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="font-serif text-2xl font-semibold text-cream">Creators Studio</span>
          </div>
          ...
          <p className="text-lg text-cream/60 leading-relaxed mb-10">
            Create, enhance, and brand your content with Creators Studio — built for makeup artists, fashion creators, and modern brands.
          </p>
          ...
          <div className="lg:hidden mb-6">
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                ...
                <span className="font-serif text-lg font-semibold text-cream">Creators Studio</span>
              </div>
